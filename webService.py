...
def get_red():
    red = xmls_to_red([open(DIRECTORIO_PROYECTO+'xml0.xml')], 'RedCoauth')
    ...
    return jsonify({'nodos':nodos, 'aristas':aristas, 'averagePathLenght':apl, 'clusteringCoefficient':cc, 'averageDegree':ad})
